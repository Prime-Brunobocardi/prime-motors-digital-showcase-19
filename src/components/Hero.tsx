      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center animate-fade-in">
          ...
          <div className="bg-black/40 backdrop-blur-sm rounded-2xl p-6 md:p-8 mb-8 max-w-4xl mx-auto border border-gray-700">
            ...
            <Button 
              size="lg" 
              className="bg-primary hover:bg-primary/90 text-white px-8 py-4 text-lg font-semibold rounded-xl transition-all duration-300 hover:scale-105 shadow-2xl"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
            ...
            <div className="text-center animate-bounce-in" style={{animationDelay: '0.3s'}}>
              ...
              <p className="text-white text-sm">Parcelas Fixas</p>
            </div>
          </div>
        </div>
      </div>
